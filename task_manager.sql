...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 04, 2016 at 08:40 AM
...
(1000015991, 14, '2016-01-20 17:58:42', 0, 0),
...
(2, 1000015991, 'admintest1', '', '2016-11-04 06:30:06', '2016-11-04 06:30:06', ' 2ms\r\n');
...
CREATE TABLE IF NOT EXISTS `user_caches` (
  ...
  `level_hours` int(11) NOT NULL DEFAULT '0',
  `diamond` int(11) NOT NULL,
  `status` varchar(1000) NOT NULL,
  `state` tinyint(2) NOT NULL DEFAULT '1' COMMENT '-1=off,0=invi,1=onl'
) ENGINE=InnoDB AUTO_INCREMENT=1000015992 DEFAULT CHARSET=latin1;

--
-- Dumping data for table `user_caches`
--

INSERT INTO `user_caches` (`user_id`, `user_name`, `user_email`, `password`, `last_active`, `avatar`, `level`, `level_hours`, `diamond`, `status`, `state`) VALUES
(10, 'tranvutuan', '', 'Tuan@123', '2016-11-03 08:22:45', '', 19, 70183, 0, 'yeu doi vai luong', 1),
(11, 'kimhc0210', '', 'A123987@@', '2016-11-02 11:14:31', '', 0, 140, 0, '', 1),
(12, 'CyberZ', '', 'Zone@$132', '2016-08-01 10:26:31', '', 0, 0, 0, '', 1),
(13, 'dinhtan89', '', 'Dinhtan89', '2016-08-01 16:05:14', '', 0, 0, 0, '', 1),
(14, 'qthai2502', '', 'ABC123456789', '2016-08-01 15:58:50', '', 0, 0, 0, '', 1),
(15, 'duongdt49mt221189', '', 'D07u4ndu0n6', '2016-04-13 10:14:09', '', 0, 0, 0, '', 1),
(16, 'wantlose', '', 'Duong168', '2016-08-01 10:26:39', '', 0, 0, 0, '', 1),
(17, 'duongdt', '', 'D07u4ndu0n6', '2016-08-01 10:28:37', '', 0, 0, 0, '', 1),
(18, 'kakashilfc', '', 'Kakashi123@', '2016-08-01 10:27:41', '', 0, 0, 0, '', 1),
(19, 'angocbkhn', '', 'Ngoc12a3', '2016-08-01 10:27:14', '', 0, 0, 0, '', 1),
(20, 'batvuonggia', '', 'Loveofromeo@@123', '2016-07-22 07:33:55', '', 0, 0, 0, '', 1),
(21, 'nguycongtu', '', 'Vxn6bbx5', '2016-08-01 10:10:13', '', 0, 0, 0, '', 1),
(1000015991, 'admintest1', '', 'Admin12345678', '2016-11-04 07:39:52', 'http://trading.gametv.vn/public_html/themes/default/img/user/noavatar.jpg', 0, 756, 0, 'toi la toi', 1);
